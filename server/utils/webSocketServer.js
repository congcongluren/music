...
// cnpm i ws -S
const ws = require("ws");  // webSocket 缩写  模块需要安装 
const webSocketServer = ws.Server;
const port = 3900;

// 1. 创建 服务器  绑定 IP +  端口   监听端口 
const wss = new webSocketServer({port});  // 启动服务器端 socket 监听 3900 
console.log(`webSocket is running at ws://0.0.0.0:3900`);  // 协议 就是  ws  协议 
